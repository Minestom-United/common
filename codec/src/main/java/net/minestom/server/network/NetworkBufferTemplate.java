...
/**
 * Vendored from Minestom: only the F1..F20 constructor functional interfaces
 * used by {@link net.minestom.server.codec.StructCodec}. The NetworkBuffer-backed
 * template methods were intentionally dropped to avoid pulling in the rest of Minestom.
 */
