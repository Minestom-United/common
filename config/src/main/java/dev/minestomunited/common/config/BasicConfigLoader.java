package dev.minestomunited.common.config;
 ...
 * {@link #register(Class, Config)} will load the config immediately rather than deferring to a future initialize call.
 *
...
public class BasicConfigLoader implements ConfigLoader {
    ...
    @Override
    public ConfigLoader addFormat(ConfigFormat format) {
